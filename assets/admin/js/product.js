(function($) {
	...
	$(document).ready(function() {
        ...
        $(".checkclick1").on( "change", function() {
         ...
         $("#size-color-display").hide();
    
        $("#size-color-check").prop('checked',false);
            }
            else{
...
$("#size-color-btn").on('click', function(){

    $("#size-color-section").append(''+
                             '<div class="size-area">'+
                                '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        ...
                                        '<div class="color-area">'+
                                                ...
                                                '<div class="input-group ">'+
                                                    '<input type="number" name="color_qty[]" value="1" min="1" class="input-field "/>'+
...
$(document).on('click','.size-color-remove', function(){

    $(this.parentNode).remove();
    if (isEmpty($('#size-color-section'))) {
                                    ...
                                    +
                                       '<div class="col-md-4 col-sm-4">'+
                                        ...
                                        '<div class="color-area">'+
                                                ...
                                                '<div class="input-group ">'+
                                                    '<input type="number" name="color_qty[]" value="0" min="1" class="input-field "/>'+
    ...
    $("#feature-section2").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-12">'+
                                            '<input type="text" name="career_emails[]" class="input-field" placeholder="Enter Your career_emails">'+
                                        '</div>'+
    ...
    $("#feature-section3").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-12">'+
                                            '<input type="text" name="contact_emails[]" class="input-field" placeholder="Enter Your contact_emails">'+
                                        '</div>'+
    ...
    $("#feature-section4").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-12">'+
                                            '<input type="text" name="support_emails[]" class="input-field" placeholder="Enter Your support_emails">'+
                                        '</div>'+
...
$("#feature-btn5").on('click', function(){

    $("#feature-section5").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-12">'+
                                            '<input type="text" name="product_emails[]" class="input-field" placeholder="Enter Your product_emails">'+
                                        '</div>'+
...
$("#size-color-check").change(function() {
    if(this.checked) {
        $("#size-color-display").show();
        $("#size-display").hide();
        $("#colors-display").addClass('showbox'); 
