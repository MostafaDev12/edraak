...
class CategoryController extends Controller
{
    ...
    {
         $datas = Category::orderBy('id','desc')->where('type','career')->get();
  ...
  public function productdatatables()
    {
         $datas = Category::orderBy('id','desc')->where('type','product')->get();
         //--- Integrating This Collection Into Datatables
         return Datatables::of($datas)
                            ->addColumn('status', function(Category $data) {
                                $class = $data->status == 1 ? 'drop-success' : 'drop-danger';
    ...
    {
        return view('admin.category.product_index');
    }
 ...
 public function productcreate()
    {
        ...
        return view('admin.category.product_create');
    }
