         ...
         return Datatables::of($datas)
                           ...
                           ->editColumn('user_id', function(Notifications $data) {
                            ...
                            ->addColumn('action', function(Notifications $data) {
                                ...
                                <a data-href="' . route('admin-notif-edit',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a><a href="javascript:;" data-href="' . route('admin-notif-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
