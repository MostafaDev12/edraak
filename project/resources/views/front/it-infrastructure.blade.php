...
<main class="bg-white">
    ...
    <div class="header cloud-p-header py-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <img src="assets/images/all-services/it_infrastructure/it-infrastructure.png" class="w-100">
                </div>
            </div>
        </div>
    </div>
    <!-- End Header -->
    <!-- Start It Infrastructure Services -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        ...
                        <p class="mb-0">Virtualization</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        <i class="fas fa-edit"></i>
                        <p class="mb-0">Servers Management</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        <i class="fas fa-edit"></i>
                        <p class="mb-0">Communication Services</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        <i class="fas fa-edit"></i>
                        <p class="mb-0">Storage Systems</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        <i class="fas fa-edit"></i>
                        <p class="mb-0">Information Security</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
                        <i class="fas fa-edit"></i>
                        <p class="mb-0">Network Management</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="it-infrastructure-service-box d-flex align-items-center">
    ...
    <!-- End It Infrastructure Services -->
</main>
