                        ...
                        <hr>
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-4 d-flex justify-content-between">
                                  ...
                                  <label class="switch">
                                      <input type="checkbox" name="section[]" value="services" {{ $data->sectionCheck('services') ? 'checked' : '' }}>
                                      <span class="slider round"></span>
                                  </label>
                              </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                              <div class="col-lg-4 d-flex justify-content-between">
                                  ...
                                  <label class="switch">
                                      <input type="checkbox" name="section[]" value="about_us"  {{ $data->sectionCheck('about_us') ? 'checked' : '' }}>
                                      <span class="slider round"></span>
                                  </label>
                              </div>
                              <div class="col-lg-2"></div>
                              <div class="col-lg-4 d-flex justify-content-between">
                                  ...
                                  <label class="switch">
                                      <input type="checkbox" name="section[]" value="gallery" {{ $data->sectionCheck('gallery') ? 'checked' : '' }}>
                                      <span class="slider round"></span>
                                  </label>
                              </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-4 d-flex justify-content-between">
                                  ...
                                  <label class="switch">
                                      <input type="checkbox" name="section[]" value="reviews" {{ $data->sectionCheck('reviews') ? 'checked' : '' }}>
                                      <span class="slider round"></span>
                                  </label>
                              </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-4 d-flex justify-content-between">
                                  ...
                                  <label class="switch">
                                      <input type="checkbox" name="section[]" value="super" {{ $data->sectionCheck('super') ? 'checked' : '' }}>
                                      <span class="slider round"></span>
                                  </label>
                              </div>
                          </div>
