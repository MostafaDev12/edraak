                          ...
                          <div class="col-lg-10">
                            <nav>
                              <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" style="display:none" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">{{ __('User Panel') }}</a>
                                <a class="nav-item nav-link" style="display:none" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">{{ __('Vendor Panel') }}</a>
                              </div>
                            </nav>
                          ...
                          <input type="text" class="input-field" name="lang250" placeholder="Biggest Festivals" required=""
                            value="{{ $lang->lang250 }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" placeholder="Subscribe Success Message"
                                                   name="subscribe_success" value="{{ $lang->subscribe_success }}" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" placeholder="Subscribe Error Message"
                                                   name="subscribe_error" value="{{ $lang->subscribe_error }}" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="input-field" name="lang909" placeholder="Subscribe for updates & special offers!" required=""
                                                   value="{{ $lang->lang909 }}">
                                        </div>
                                    </div>
