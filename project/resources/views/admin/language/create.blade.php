...
<div class="content-area">
  ...
  <div class="row">
                ...
                <div class="col-lg-7">
                  <input type="text" class="input-field" name="sign" placeholder="{{ __('en') }}" required=""
                    value="en">
                </div>
              </div>
                ...
                <div class="col-lg-10">
                  <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                      ...
                      <a class="nav-item nav-link" id="nav-profile-tab" style="display:none" data-toggle="tab" href="#nav-profile" role="tab"
                        aria-controls="nav-profile" aria-selected="false">{{ __('Panel') }}</a>
                      <a class="nav-item nav-link" id="nav-about-tab" style="display:none" data-toggle="tab" href="#nav-about" role="tab"
                        aria-controls="nav-about" aria-selected="false">{{ __('Panel') }}</a>
                    </div>
                  </nav>
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang16" placeholder="About us" required=""
                            value="About us">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang11" placeholder="What we do" required=""
                            value="What we do">
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang221" placeholder="Gallery" required=""
                            value="Gallery">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang222" placeholder="Review" required=""
                            value="Review">
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang223" placeholder="what we do" required=""
                                 value="what we do">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang12" placeholder="view more" required=""
                                 value="view more">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Read The Latest News *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang13" placeholder="Read The Latest News" required=""
                                 value="Read The Latest News">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Recent Articles *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang220" placeholder="Recent Articles" required=""
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Call Us On 1234 456 780 *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang1" placeholder="Call Us On 1234 456 780" required=""
                                 value="Call Us On 1234 456 780">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">or Enter Your Details Team *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang2" placeholder="or Enter Your Details Team"
                                 required="" value="or Enter Your Details Team">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading"> Will Contact You To Discuss Your Event *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang3" placeholder=" Will Contact You To Discuss Your Event" required=""
                                 value=" Will Contact You To Discuss Your Event">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang6" placeholder="Location" required=""
                                 value="Location">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Call Now *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang7" placeholder="Call Now" required=""
                                 value="Call Now">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Mail Info *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang8" placeholder="Mail Info" required=""
                                 value="Mail Info">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang53" placeholder="Subject" required=""
                                 value="Subject">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang35" placeholder="Tags" required=""
                                 value="Tags">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang36" placeholder="Recent Articles" required=""
                                 value="Recent Articles">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang37" placeholder="Archives" required=""
                                 value="Archives">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Social Sharing *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang38" placeholder="Social Sharing" required=""
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang39" placeholder="Comments" required=""
                                 value="Comments">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Client's Comment *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang40" placeholder="Client's Comment" required=""
                                 value="Client's Comment">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Your Comment *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang41" placeholder="Your Comment" required=""
                                 value="Your Comment">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Submit A Comment *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang46" placeholder="Submit A Comment" required=""
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Recent Events *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang43" placeholder="Recent Events" required=""
                                 value="Recent Events">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Flickr Photos *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang44" placeholder="Flickr Photos" required=""
                                 value="Flickr Photos">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">What People Say? *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang4" placeholder="What People Say?" required=""
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Client's Testimonials *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang5" placeholder="Client's Testimonials" required=""
                                 value="Client's Testimonials">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang9" placeholder="History" required=""
                                 value="History">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang10" placeholder="Our Team" required=""
                                 value="Our Team">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Meet the people who make awesome stuffs *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang14" placeholder="Meet the people who make awesome stuffs" required=""
                                 value="Meet the people who make awesome stuffs">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Sponsored By *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang15" placeholder="Sponsored By" required=""
                                 value="Sponsored By">
                        </div>
                      </div>
                      ...
                      <div class="row" >
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang19" placeholder="Faq's" required=""
                                 value="Faq's">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Amazing Partners & Sponsors *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang25" placeholder="Amazing Partners & Sponsors" required=""
                            value="Amazing Partners & Sponsors">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Coach Tracker *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang200" placeholder="Coach Tracker" required=""
                                 value="Coach Tracker">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Track Your Coach in Real Time. *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang230" placeholder="Track Your Coach in Real Time." required=""
                                 value="Track Your Coach in Real Time.">
                        </div>
                      </div>
...
<hr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang201" placeholder="Overview"
                            required="" value="Overview">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang202" placeholder="Features" required=""
                            value="Features">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Speaker *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang203" placeholder="Speaker" required=""
                            value="Speaker">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang231" placeholder="Get In Touch"
                            required="" value="Get In Touch">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang232" placeholder="Register Now" required=""
                            value="Register Now">
                        </div>
                      </div>
   <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang204" placeholder="Pricing Plans" required=""
                            value="Pricing Plans">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Biggest Festivals *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang250" placeholder="Biggest Festivals" required=""
                            value="Biggest Festivals">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="left-area">
                            <h4 class="heading">Subscribe for updates & special offers! *</h4>
                            <p class="sub-heading">(In Any Language)</p>
                          </div>
                        </div>
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang909" placeholder="Subscribe for updates & special offers!" required="" value="Subscribe for updates & special offers!">
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade" style="display:none" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
...
<div class="row">
                    ...
                    <div class="tab-pane fade" style="display:none" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
