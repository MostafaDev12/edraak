				...
				<div class="col-lg-12">
					<div class="product-description">
						<div class="body-area">
							...
							<form id="geniusform" action="{{route('admin-product-update',$data->id)}}" method="POST" enctype="multipart/form-data">
								{{csrf_field()}}
 ...
 <div class="row">
											...
											<div class="col-lg-7">
												<select id="type" name="type" required="" >
														...
														<option data-href=" " value="1" {{ $data->type == 1 ? "selected":""}}>{{ __('primary') }}</option>
														<option data-href=" " value="0" {{ $data->type == 0 ? "selected":""}}>{{ __('secondary') }}</option>
										...
										<div class="row">
											...
											<div class="col-lg-7">
												...
												<!--	<option>{{ __('Select Category') }}</option>-->
													...
													@foreach($cats as $cat)
														<option data-href=" " value="{{$cat->id}}" {{ in_array($cat->id, json_decode($data->category_id))  ? "selected":""}} >{{$cat->name}}</option>
													@endforeach
												</select>
											</div>
										</div>
									...
									{{--	<div class="row">
										...
										<div class="row">
											...
											<div class="col-lg-7">
												<div class="text-editor">
													<textarea name="min_details" class=" form-control">{{$data->min_details}}</textarea>
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-lg-7">
												<div class="text-editor">
													<textarea name="min_details_ar" class=" form-control">{{$data->min_details_ar}}</textarea>
												</div>
											</div>
										</div>
     	...
     	<div class="row">
											...
											<div class="col-lg-7">
												<input type="number" class="input-field" placeholder="{{ __('Enter Product monthly price') }}" min="0" value="{{$data->monthly}}" name="monthly" required="">
											</div>
										</div>
	<div class="row">
											<div class="col-lg-4">
											...
											<div class="col-lg-7">
												<input type="number" class="input-field" placeholder="{{ __('Enter Product half_yearly price') }}" min="0" value="{{$data->half_yearly}}" name="half_yearly" required="">
											</div>
										</div>
	<div class="row">
											<div class="col-lg-4">
											...
											<div class="col-lg-7">
												<input type="number" class="input-field" placeholder="{{ __('Enter Product yearly price') }}" min="0" value="{{$data->yearly}}" name="yearly" required="">
											</div>
										</div>
									...
									<div class="row">
											...
											<div class="col-lg-7">
												<input type="number" class="input-field" placeholder="{{ __('Enter Product final_sale price') }}" min="0" value="{{$data->final_sale}}" name="final_sale" required="">
											</div>
										</div>
	...
	<div class="row">
											...
											<div class="col-lg-7">
												<input type="text" class="input-field" placeholder="{{ __('Enter Product youtube link') }}"  value="{{$data->youtube}}" name="youtube" >
											</div>
										</div>
   ...
   <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{$data->icon_photo ? asset('assets/images/products/'.$data->icon_photo) :  asset('assets/admin/images/upload.png') }});">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{$data->photo ? asset('assets/images/products/'.$data->photo) :  asset('assets/admin/images/upload.png') }});">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->video_photo ? asset('assets/images/products/'.$data->video_photo) : asset('assets/admin/images/upload.png') }});">
