...
-->                         <input class="d-inline-block mybtn1" type="file" onchange="document.getElementById('landscapes2').src = window.URL.createObjectURL(this.files[0])" id="hover_photo" name="hover_photo" value="">
				...
				<div class="modal-body">
					<div class="top-area">
						<div class="row">
							...
							<div class="col-sm-12 text-center">( <small>You can upload multiple Images.</small> )<span class='span-img-size'>image size 205px X 205px</span></div>
						</div>
					</div>
