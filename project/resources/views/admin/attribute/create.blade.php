                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                         <div class="row mb-2 counterrow" v-for="n in counter" :id="'counterrow'+n">
                           <div class="col-lg-4">
                             <div class="left-area">
                                 <h4 class="heading">{{ __('Option') }} *</h4><br>
                                 <p class="sub-heading">{{ __('Arabic') }}</p>
                             </div>
                           </div>
                           <div class="col-lg-6">
                             <input :id="'optionfield'+n" type="text" class="input-field" name="options[]" value="" placeholder="Option label" required>
                             <input :id="'optionfield'+n" type="text" class="input-field" name="optionsa[]" value="" placeholder="Arabic Option label" required>
                           </div>
                           <div class="col-lg-1">
                ...
                <div class="row d-none">
                  <div class="col-lg-7 offset-lg-4">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="priceStatus1" name="price_status" class="custom-control-input"  value="1">
